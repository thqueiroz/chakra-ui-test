                    ...
                    <Flex mb="8" justify="space-between" align="center">
                        ...
                        <Link href="/users/create" passHref>
                            <Button
                                ...
                                fontSize="sm"
                                colorScheme="pink"
                                leftIcon={<Icon as={RiAddLine} fontSize="20" />}>Criar novo
                            </Button>
                        </Link>
                    </Flex>
                    ...
                    <Table colorScheme="whiteAlpha">
                        ...
                        <Tbody>
                            <Tr>
                                ...
                                <Td>
                                    <Box>
                                        <Text fontWeight="bold">Tiago Henrique Queiroz</Text>
                                        <Text fontSize="sm" color="gray.300">tiagohqueiroz@icloud.com</Text>
                                    </Box>
                                </Td>
